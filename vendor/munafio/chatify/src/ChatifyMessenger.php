...
class ChatifyMessenger
{
    ...
    {
//	echo config('chatify.attachments.allowed_videos';
        return config('chatify.attachments.allowed_videos');
    }


    public function getAllowedAudios()
    {
        return config('chatify.attachments.allowed_audios');
    }
...
if (isset($msg->attachment)) {
    ...
    // Obtém as extensões permitidas para imagens e vídeos
    $allowedImages = $this->getAllowedImages();
    $allowedVideos = $this->getAllowedVideos();
    $allowedAudios = $this->getAllowedAudios();

    // Verifica se a extensão está na lista de imagens ou vídeos permitidos
